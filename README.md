...
## How to use it?
 ...
 - After having successfully built, a new container should show up below `eu.gcr.io/$PROJECT_ID/cloudbuild-android`.
...
eg. `./gradlew mobile:cloudKmsDecrypt mobile:assembleRelease mobile:appDistributionUploadRelease`.
